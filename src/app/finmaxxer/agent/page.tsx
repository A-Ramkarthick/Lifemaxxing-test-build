...
export default function FinMaxxerAgentPage() {
  return (
    <NokiaLayout>
      <div className="flex flex-col h-full space-y-4 pt-2">
        ...
        <div className="flex items-center gap-2 border-b-2 border-nokia-dim/30 pb-2 mb-2">
          ...
          <h1 className="text-xl font-bold uppercase tracking-wider">FinMaxxer Live</h1>
        </div>

        {/* Video Feed */}
        <AgentVideoFeed agentName="FinMaxxer" />

        {/* Chat Interface */}
        <div className="flex-1 min-h-0 border-t-2 border-nokia-dim/30 pt-2">
           <AgentChat 
             agentName="FinMaxxer" 
             initialMessage="Financial markets are volatile today. Net worth calculation complete. Shall we review your Q1 allocations?"
           />
        </div>
      </div>
    </NokiaLayout>
