    ...
    <NokiaLayout>
      <div className="flex flex-col h-full space-y-4 pt-2">
        <div className="flex items-center gap-2 border-b-2 border-nokia-dim/30 pb-2 mb-2">
          <Link href="/studymaxxer">
            <button className="p-1 hover:bg-nokia-dim/20 rounded-sm">
              <ArrowLeft className="w-5 h-5" />
            </button>
          </Link>
          <h1 className="text-xl font-bold uppercase tracking-wider">Neural Link</h1>
        </div>

        <AgentVideoFeed agentName="StudyMaxxer" />

        <div className="flex-1 min-h-0 border-t-2 border-nokia-dim/30 pt-2">
           <AgentChat 
             agentName="StudyMaxxer" 
             initialMessage="I've digested the PDF you uploaded. The concept on page 4 regarding quantum entanglement seems crucial. Shall I quiz you?"
           />
        </div>
      </div>
    </NokiaLayout>
